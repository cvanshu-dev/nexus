...
export const Hero = () => {
  ...
  return (
    <section id="hero" className="relative h-dvh w-screen overflow-x-hidden">
        ...
        <div className="absolute left-0 top-0 z-40 size-full">
          <div className="mt-24 px-5 sm:px-10">
            ...
            <p className="mb-5 max-w-64 font-robert-regular text-blue-100">
              Execute on a proven roadmap.<br />
              Eliminate confusion. Achieve structure.
            </p>
      ...
      {/*<p className="mb-5 max-w-64 font-robert-regular text-blue-100">
              We are the elite collective, turning skill decay<br />
              into a verified, high-impact project log.
            </p>*/}
    </section>
  );
};
